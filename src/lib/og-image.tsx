...
export async function createBrandedOgImage({ eyebrow, title, detail }: OgImageOptions) {
    ...
    >
      ...
      <div
        style={{
          ...
          position: "absolute",
          inset: 0,
          backgroundImage: "linear-gradient(90deg, rgba(22,22,22,.94) 0%, rgba(22,22,22,.8) 48%, rgba(22,22,22,.22) 100%)",
        }}
      />
      <div
        style={{
